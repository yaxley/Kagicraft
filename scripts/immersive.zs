...
val electrumPlate = <item:immersiveengineering:plate_electrum>;
val iron = <item:minecraft:iron_ingot>;
val ironPlate = <item:immersiveengineering:plate_iron>;
val steelPlate = <item:immersiveengineering:plate_steel>;
val lead = <item:immersiveengineering:ingot_lead>;
val leadPlate = <item:immersiveengineering:plate_lead>;
...
val silverPlate = <item:immersiveengineering:plate_silver>;
